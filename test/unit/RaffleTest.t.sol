...
contract RaffleTest is CodeConstants, Test {
    ...
    function checkUpkeepReturnsFalseIfEnoughTimeHasPassed() public raffleEntered {
        raffle.performUpkeep("");
    ...
    function testPerformUpkeepUpdatesRaffleStateAndEmitsRequestId() public raffleEntered {
        // Act/ Assert
        vm.recordLogs(); // keep track of logs of calls after this point
        raffle.performUpkeep("");
    ...
    function testFulfillrandomWordsCanOnlyBeCalldedAfterPerformUpkeep(uint256 randomRequestId)
        public
        raffleEntered
        skipFork
    {
