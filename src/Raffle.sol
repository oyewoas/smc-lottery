 ...
 * @notice This contract is for creatin a sample raffle
...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    error Raffle__UpkeepNotNeeded(uint256 balance, uint256 playersLength, uint256 reffleState);
    ...
    function enterRaffle() external payable {
        console.log("msg.value: %s, i_entranceFee: %s", msg.value, i_entranceFee);
     ...
     * 1. The time interval has passwed between raffle runs
    ...
    /**
     * @dev This function is called by the Chainlink VRF Coordinator
     */
